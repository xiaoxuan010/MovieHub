...
/**
 * 测试订单生成器
 * 用于在测试环境中创建一个固定订单号的订单，方便测试支付宝异步通知
 * 
 * 运行方式：
 * ./mvnw spring-boot:run -Dspring-boot.run.profiles=test-order-generator
 */
@SpringBootApplication
@Profile("test-order-generator")
public class TestOrderGenerator implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(TestOrderGenerator.class, args);
    }
